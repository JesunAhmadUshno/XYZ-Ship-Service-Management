...
public class Start {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("------------------------------------------------");
        System.out.println("------------------------------------------------");
        System.out.println("|| Welcome to Bengal Cruise Ship Service ||");
        System.out.println("------------------------------------------------");
        System.out.println("------------------------------------------------");

        boolean repeat = true;
        while(repeat) {
            System.out.println("\nPress to Execute Followings?");
            System.out.println("1. Passanger Management");
            System.out.println("2. Crew Management");
            System.out.println("3. Sail Booking");
            System.out.println("4. Sail Booking History");
            ...
            switch(choice) {
                case 1:
                    System.out.println("------------------------------------------------");
                    System.out.println("||  Bengal Cruise Ship | Passanger Management ||");
                    System.out.println("------------------------------------------------");
                ...
                case 2:
                    System.out.println("------------------------------------------------");
                    System.out.println(" || Bengal Cruise Ship | Crew Management ||");
                    System.out.println("------------------------------------------------");
                    System.out.println("You have the following options:");
                ...
                case 3: 
                    System.out.println("------------------------------------------------");
                    System.out.println("|| Bengal Cruise Ship | Sail Booking ||");
                    System.out.println("------------------------------------------------");
                    BengalCruiseShipService sail = new BengalCruiseShipService();
                    ...
                    if(p2 != null){
                        ...
                        if(choice3 >= 1 && choice3 <= 4) {
                            switch(choice3){
                                case 1: 
                                    p2.setTicket("Sail No 001");
                                    file.writeInFile("Sail No 001");
                                    break;
                                case 2:
                                    p2.setTicket("Sail No 002");
                                    file.writeInFile("Sail No 002");
                                    break;
                                case 3:
                                    p2.setTicket("Sail No 003");
                                    file.writeInFile("Sail No 003");
                                    break;
                                case 4:
                                    p2.setTicket("Sail No 004");
                                    file.writeInFile("Sail No 004");
                                    break;
                            }
                            System.out.println("Sail Booked");
                        }else {
                            System.out.println("Invalid");
                        }
                    }else {
                ...
                case 4:
                    System.out.println("------------------------------------------------");
                    System.out.println("        || Sail Booking History ||");
                    System.out.println("------------------------------------------------");
